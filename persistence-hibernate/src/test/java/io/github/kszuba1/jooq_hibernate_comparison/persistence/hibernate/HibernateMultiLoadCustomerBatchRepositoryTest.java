...
class HibernateMultiLoadCustomerBatchRepositoryTest extends CustomerBatchRepositoryContract {
	...
	static void startDatabase() {
		...
		repository = new HibernateCustomerBatchRepository(entityManagerFactory, true);
	}
