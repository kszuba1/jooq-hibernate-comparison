...
class HibernateCustomerBatchRepositoryTest extends CustomerBatchRepositoryContract {
	...
	static void startDatabase() {
		...
		repository = new HibernateCustomerBatchRepository(entityManagerFactory);
	}
